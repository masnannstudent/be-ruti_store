...
type ReviewModels struct {
	...
	OrderDetailsID uint64              `gorm:"column:order_details_id" json:"order_details_id"`
	OrderDetails   OrderDetailsModels  `gorm:"foreignKey:OrderDetailsID" json:"order_details"`
